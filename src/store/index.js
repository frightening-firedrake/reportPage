...
//		{id:'10.境外黑社会',name:'10.境外黑社会'},
	...
	informTypeList:[
		{id:'1、威胁政治安全特别是制度安全、政权安全以及向政治领域渗透的黑恶势力',name:'1、威胁政治安全特别是制度安全、政权安全以及向政治领域渗透的黑恶势力'},
		{id:'2、把持基层政权、操纵破坏基层换届选举、垄断农村资源、侵吞集体资产的黑恶势力',name:'2、把持基层政权、操纵破坏基层换届选举、垄断农村资源、侵吞集体资产的黑恶势力'},
		{id:'3、利用家族、宗族势力横行乡里、称霸一方、欺压残害百姓的“村霸”等黑恶势力',name:'3、利用家族、宗族势力横行乡里、称霸一方、欺压残害百姓的“村霸”等黑恶势力'},
		{id:'4、在征地、租地、拆迁、工程项目建设等过程中煽动闹事的黑恶势力',name:'4、在征地、租地、拆迁、工程项目建设等过程中煽动闹事的黑恶势力'},
		{id:'5、在建筑工程、交通运输、矿产资源、渔业捕捞等行业、领域，强揽工程、恶意竞标、非法占地、滥开滥采的黑恶势力',name:'5、在建筑工程、交通运输、矿产资源、渔业捕捞等行业、领域，强揽工程、恶意竞标、非法占地、滥开滥采的黑恶势力'},
		{id:'6、在商贸集市、批发市场、机场车站、旅游景区等场所欺行霸市、强买强卖、收保护费的市霸、行霸等黑恶势力',name:'6、在商贸集市、批发市场、机场车站、旅游景区等场所欺行霸市、强买强卖、收保护费的市霸、行霸等黑恶势力'},
		{id:'7、操纵、经营“黄赌毒”等违法犯罪活动的黑恶势力',name:'7、操纵、经营“黄赌毒”等违法犯罪活动的黑恶势力'},
		{id:'8、非法高利放贷、暴力讨债的黑恶势力',name:'8、非法高利放贷、暴力讨债的黑恶势力'},
		{id:'9、盗掘古墓葬以及倒卖、走私文物的黑恶势力',name:'9、盗掘古墓葬以及倒卖、走私文物的黑恶势力'},
		{id:'10、插手民间纠纷，充当“地下执法队”的黑恶势力',name:'10、插手民间纠纷，充当“地下执法队”的黑恶势力'},
		{id:'11、境外黑社会入境发展渗透以及跨国跨境的黑恶势力',name:'11、境外黑社会入境发展渗透以及跨国跨境的黑恶势力'},
		{id:'12、黑恶势力“保护伞”',name:'12、黑恶势力“保护伞”'},
...
const getters = {
    ...
    industryFieldList:function(state){
    	if(state.industryFieldList.length){    		
    		return state.industryFieldList;
    	}else{
    		return JSON.parse(sessionStorage.getItem("industryFieldList")) 		
    	}
    },
...
const mutations = {
	...
	setIndustryFieldList(state,payload){
		state.industryFieldList=payload.industryFieldList;
		sessionStorage.setItem('industryFieldList', JSON.stringify(state.industryFieldList));
	},
