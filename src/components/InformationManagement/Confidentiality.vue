...
//            this.$router.go(-1);
    ...
    //获取文档内容
    submit(form) {
    	if(!this.$_ault_alert('secrecy:save')){
	  			return
	  	}
      var data={};
  ...
  data() {
    return {
      DetailsURL: this.apiRoot + "secrecy/findAll",
      articleSaveURL: this.apiRoot + "secrecy/save",
      articleEditURL: this.apiRoot + "secrecy/edit",
